...
--
-- Host: localhost
-- Generation Time: Jan 01, 2017 at 08:32 AM
...
--
CREATE DATABASE `db_ecommerce_batch09` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `db_ecommerce_batch09`;
...
(9, 'T-Shirt', '<p>\r\n kkk</p>\r\n', 0, 56, 'http://localhost/ecommerce_batch09/images/product_images/Chrysanthemum.jpg', 6, 0),
(10, 'T-Shirthhh', 'Long T-Shirtdd', 0, 5, '', 1, 0),
(11, 'T-Shirtggggggg', '<p>\r\n gg</p>\r\n', 0, 0, 'http://localhost/shop/images/product_images/big_pic.jpg', 7, 1);
--
-- Database: `dbebusiness`
--
CREATE DATABASE `dbebusiness` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `dbebusiness`;
...
--
CREATE DATABASE `dbecommerce` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `dbecommerce`;
...
INSERT INTO `tbadmin` (`admin_id`, `admin_name`, `admin_email_address`, `admin_password`) VALUES
(1, 'Abdullah al Muhin', 'muhin39@gmail.com', 'e10adc3949ba59abbe56e057f20f883e'),
(2, 'saon', 'swesaon@gmail.com', '123456');
...
INSERT INTO `tbcategory` (`category_id`, `category_name`, `category_description`, `publication_status`) VALUES
(1, 'First Category', 'First Category description', 1),
(6, 'Second Category.', 'This is Second Category.', 1),
(7, 'Third category', 'This is Third category', 1);
...
INSERT INTO `tblclient` (`client_id`, `client_name`, `client_email_address`, `client_password`, `address`, `country`) VALUES
(6, 'Abdullah al Muhin', 'muhin39@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Rampura', 'Bangladesh'),
(7, 'Farjana Afrin', 'afrin@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Rampura', 'Bangladesh'),
(8, 'Azaml Oli', 'oli@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Bashundhara', 'Bangladesh'),
(11, 'Shamsuddin', 'shamsuddin@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'bogra', '0');
...
INSERT INTO `tblcustomer` (`customer_id`, `first_name`, `last_name`, `customer_email_address`, `password`, `mobile_no`, `address`, `company_name`, `city`, `country`, `zip_code`) VALUES
(1, 'Alif', 'Ahmed', 'alif@yahoo.com', 'b79b517ce8cd6cf7c4ed8238ae4a3821', '35235', 'x zx ', '0', 'sdas', 'CA', 'asf');
...
INSERT INTO `tbproduct` (`product_id`, `product_name`, `product_description`, `product_price`, `product_quantity`, `product_image`, `category_id`, `publication_status`) VALUES
(6, 'Logo', '', 10, 100000, 'http://localhost/ecommerce_batch09/images/product_images/logo1.jpg', 7, 1),
(7, 'HP Laptop', '<p>\r\n Test descripton</p>\r\n', 8000, 1000, 'http://localhost/ecommerce_batch09/images/product_images/product-img5.jpg', 1, 1),
(8, 'Joy Stick', '', 5, 50, 'http://localhost/ecommerce_batch09/images/product_images/featured-img4.jpg', 7, 1);
--
...
('def', 'db_ecommerce_batch09', 'tbl_admin', 'admin_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_admin', 'admin_name', 2, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_admin', 'admin_email_address', 3, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_admin', 'admin_password', 4, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_category', 'category_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_category', 'category_name', 2, NULL, 'NO', 'varchar', 256, 768, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(256)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_category', 'category_description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_category', 'publication_status', 4, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_client', 'client_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_client', 'client_name', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_client', 'client_email_address', 3, NULL, 'NO', 'varchar', 256, 768, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(256)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_client', 'client_password', 4, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_client', 'address', 5, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_client', 'country', 6, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_customer', 'customer_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(6)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_customer', 'first_name', 2, NULL, 'NO', 'varchar', 25, 75, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_customer', 'last_name', 3, NULL, 'NO', 'varchar', 25, 75, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_customer', 'customer_email_address', 4, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_customer', 'password', 5, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_customer', 'mobile_no', 6, NULL, 'NO', 'varchar', 11, 33, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(11)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_customer', 'address', 7, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_customer', 'company_name', 8, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_customer', 'city', 9, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_customer', 'country', 10, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_customer', 'zip_code', 11, NULL, 'NO', 'varchar', 5, 15, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(5)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_product', 'product_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_product', 'product_name', 2, NULL, 'NO', 'varchar', 256, 768, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(256)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_product', 'product_description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_product', 'product_price', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_product', 'product_quantity', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(3)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_product', 'product_image', 6, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_product', 'category_id', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', '', '', 'select,insert,update,references', ''),
('def', 'db_ecommerce_batch09', 'tbl_product', 'publication_status', 8, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_admin', 'admin_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_admin', 'admin_name', 2, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_admin', 'admin_email_address', 3, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_admin', 'admin_password', 4, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_category', 'category_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_category', 'category_name', 2, NULL, 'NO', 'varchar', 256, 768, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(256)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_category', 'category_description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_category', 'publication_status', 4, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_client', 'client_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_client', 'client_name', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_client', 'client_email_address', 3, NULL, 'NO', 'varchar', 256, 768, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(256)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_client', 'client_password', 4, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_client', 'address', 5, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_client', 'country', 6, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_customer', 'customer_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(6)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_customer', 'first_name', 2, NULL, 'NO', 'varchar', 25, 75, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_customer', 'last_name', 3, NULL, 'NO', 'varchar', 25, 75, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_customer', 'customer_email_address', 4, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_customer', 'password', 5, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_customer', 'mobile_no', 6, NULL, 'NO', 'varchar', 11, 33, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(11)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_customer', 'address', 7, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_customer', 'company_name', 8, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_customer', 'city', 9, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_customer', 'country', 10, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_customer', 'zip_code', 11, NULL, 'NO', 'varchar', 5, 15, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(5)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_product', 'product_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_product', 'product_name', 2, NULL, 'NO', 'varchar', 256, 768, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(256)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_product', 'product_description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_product', 'product_price', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_product', 'product_quantity', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(3)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_product', 'product_image', 6, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_product', 'category_id', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', '', '', 'select,insert,update,references', ''),
('def', 'dbebusiness', 'tbl_product', 'publication_status', 8, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tbadmin', 'admin_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tbadmin', 'admin_name', 2, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tbadmin', 'admin_email_address', 3, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tbadmin', 'admin_password', 4, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tbcategory', 'category_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tbcategory', 'category_name', 2, NULL, 'NO', 'varchar', 256, 768, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(256)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tbcategory', 'category_description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tbcategory', 'publication_status', 4, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tblclient', 'client_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tblclient', 'client_name', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tblclient', 'client_email_address', 3, NULL, 'NO', 'varchar', 256, 768, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(256)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tblclient', 'client_password', 4, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tblclient', 'address', 5, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tblclient', 'country', 6, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tblcustomer', 'customer_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(6)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tblcustomer', 'first_name', 2, NULL, 'NO', 'varchar', 25, 75, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tblcustomer', 'last_name', 3, NULL, 'NO', 'varchar', 25, 75, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tblcustomer', 'customer_email_address', 4, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tblcustomer', 'password', 5, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tblcustomer', 'mobile_no', 6, NULL, 'NO', 'varchar', 11, 33, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(11)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tblcustomer', 'address', 7, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tblcustomer', 'company_name', 8, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tblcustomer', 'city', 9, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tblcustomer', 'country', 10, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tblcustomer', 'zip_code', 11, NULL, 'NO', 'varchar', 5, 15, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(5)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tbproduct', 'product_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tbproduct', 'product_name', 2, NULL, 'NO', 'varchar', 256, 768, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(256)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tbproduct', 'product_description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tbproduct', 'product_price', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tbproduct', 'product_quantity', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(3)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tbproduct', 'product_image', 6, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tbproduct', 'category_id', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', '', '', 'select,insert,update,references', ''),
('def', 'dbecommerce', 'tbproduct', 'publication_status', 8, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
...
('def', 'shop_apps', 'tbl_category', 'category_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop_apps', 'tbl_category', 'category_name', 2, NULL, 'NO', 'varchar', 256, 768, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(256)', '', '', 'select,insert,update,references', ''),
('def', 'shop_apps', 'tbl_category', 'category_description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop_apps', 'tbl_category', 'publication_status', 4, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
('def', 'shop_apps', 'tbl_product', 'product_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop_apps', 'tbl_product', 'product_name', 2, NULL, 'NO', 'varchar', 256, 768, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(256)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `COLUMN_DEFAULT`, `IS_NULLABLE`, `DATA_TYPE`, `CHARACTER_MAXIMUM_LENGTH`, `CHARACTER_OCTET_LENGTH`, `NUMERIC_PRECISION`, `NUMERIC_SCALE`, `CHARACTER_SET_NAME`, `COLLATION_NAME`, `COLUMN_TYPE`, `COLUMN_KEY`, `EXTRA`, `PRIVILEGES`, `COLUMN_COMMENT`) VALUES
('def', 'shop_apps', 'tbl_product', 'product_description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop_apps', 'tbl_product', 'product_price', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'shop_apps', 'tbl_product', 'product_quantity', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(3)', '', '', 'select,insert,update,references', ''),
('def', 'shop_apps', 'tbl_product', 'product_image', 6, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop_apps', 'tbl_product', 'category_id', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', '', '', 'select,insert,update,references', ''),
('def', 'shop_apps', 'tbl_product', 'publication_status', 8, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
...
('def', 'wordpress', 'wp_commentmeta', 'meta_key', 3, NULL, 'YES', 'varchar', 255, 1020, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(255)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_commentmeta', 'meta_value', 4, NULL, 'YES', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'longtext', '', '', 'select,insert,update,references', ''),
...
('def', 'wordpress', 'wp_comments', 'comment_author', 3, NULL, 'NO', 'tinytext', 255, 255, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'tinytext', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_comments', 'comment_author_email', 4, '', 'NO', 'varchar', 100, 400, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(100)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_comments', 'comment_author_url', 5, '', 'NO', 'varchar', 200, 800, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_comments', 'comment_author_IP', 6, '', 'NO', 'varchar', 100, 400, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
...
('def', 'wordpress', 'wp_comments', 'comment_content', 9, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_comments', 'comment_karma', 10, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_comments', 'comment_approved', 11, '1', 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_comments', 'comment_agent', 12, '', 'NO', 'varchar', 255, 1020, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_comments', 'comment_type', 13, '', 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
...
('def', 'wordpress', 'wp_links', 'link_url', 2, '', 'NO', 'varchar', 255, 1020, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_links', 'link_name', 3, '', 'NO', 'varchar', 255, 1020, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_links', 'link_image', 4, '', 'NO', 'varchar', 255, 1020, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_links', 'link_target', 5, '', 'NO', 'varchar', 25, 100, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_links', 'link_description', 6, '', 'NO', 'varchar', 255, 1020, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_links', 'link_visible', 7, 'Y', 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', 'MUL', '', 'select,insert,update,references', ''),
...
('def', 'wordpress', 'wp_links', 'link_rel', 11, '', 'NO', 'varchar', 255, 1020, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_links', 'link_notes', 12, NULL, 'NO', 'mediumtext', 16777215, 16777215, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'mediumtext', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_links', 'link_rss', 13, '', 'NO', 'varchar', 255, 1020, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
...
('def', 'wordpress', 'wp_options', 'option_name', 2, '', 'NO', 'varchar', 64, 256, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(64)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_options', 'option_value', 3, NULL, 'NO', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'longtext', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_options', 'autoload', 4, 'yes', 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
...
('def', 'wordpress', 'wp_postmeta', 'meta_key', 3, NULL, 'YES', 'varchar', 255, 1020, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(255)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_postmeta', 'meta_value', 4, NULL, 'YES', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'longtext', '', '', 'select,insert,update,references', ''),
...
('def', 'wordpress', 'wp_posts', 'post_content', 5, NULL, 'NO', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'longtext', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_posts', 'post_title', 6, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_posts', 'post_excerpt', 7, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_posts', 'post_status', 8, 'publish', 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_posts', 'comment_status', 9, 'open', 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_posts', 'ping_status', 10, 'open', 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_posts', 'post_password', 11, '', 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_posts', 'post_name', 12, '', 'NO', 'varchar', 200, 800, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(200)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_posts', 'to_ping', 13, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_posts', 'pinged', 14, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'text', '', '', 'select,insert,update,references', ''),
...
('def', 'wordpress', 'wp_posts', 'post_content_filtered', 17, NULL, 'NO', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'longtext', '', '', 'select,insert,update,references', ''),
...
('def', 'wordpress', 'wp_posts', 'guid', 19, '', 'NO', 'varchar', 255, 1020, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_posts', 'menu_order', 20, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_posts', 'post_type', 21, 'post', 'NO', 'varchar', 20, 80, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(20)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_posts', 'post_mime_type', 22, '', 'NO', 'varchar', 100, 400, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
...
('def', 'wordpress', 'wp_term_taxonomy', 'taxonomy', 3, '', 'NO', 'varchar', 32, 128, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(32)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_term_taxonomy', 'description', 4, NULL, 'NO', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'longtext', '', '', 'select,insert,update,references', ''),
...
('def', 'wordpress', 'wp_terms', 'name', 2, '', 'NO', 'varchar', 200, 800, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(200)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_terms', 'slug', 3, '', 'NO', 'varchar', 200, 800, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(200)', 'MUL', '', 'select,insert,update,references', ''),
...
('def', 'wordpress', 'wp_usermeta', 'meta_key', 3, NULL, 'YES', 'varchar', 255, 1020, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(255)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_usermeta', 'meta_value', 4, NULL, 'YES', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'longtext', '', '', 'select,insert,update,references', ''),
...
('def', 'wordpress', 'wp_users', 'user_login', 2, '', 'NO', 'varchar', 60, 240, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(60)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_users', 'user_pass', 3, '', 'NO', 'varchar', 64, 256, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(64)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_users', 'user_nicename', 4, '', 'NO', 'varchar', 50, 200, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(50)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_users', 'user_email', 5, '', 'NO', 'varchar', 100, 400, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_users', 'user_url', 6, '', 'NO', 'varchar', 100, 400, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
...
('def', 'wordpress', 'wp_users', 'user_activation_key', 8, '', 'NO', 'varchar', 60, 240, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(60)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_users', 'user_status', 9, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'wordpress', 'wp_users', 'display_name', 10, '', 'NO', 'varchar', 250, 1000, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'varchar(250)', '', '', 'select,insert,update,references', '');
...
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '2428'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '2003'),
('INNODB_BUFFER_POOL_PAGES_DATA', '377'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '38'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7814'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '3404'),
('INNODB_BUFFER_POOL_READS', '378'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '37'),
('INNODB_DATA_FSYNCS', '38'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '8376320'),
('INNODB_DATA_READS', '388'),
('INNODB_DATA_WRITES', '49'),
('INNODB_DATA_WRITTEN', '636928'),
('INNODB_DBLWR_PAGES_WRITTEN', '19'),
('INNODB_DBLWR_WRITES', '7'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '5'),
('INNODB_LOG_WRITES', '14'),
('INNODB_OS_LOG_FSYNCS', '23'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '9728'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '0'),
('INNODB_PAGES_READ', '377'),
('INNODB_PAGES_WRITTEN', '19'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '1140'),
('UPTIME_SINCE_FLUSH_STATUS', '1140');
...
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.20\\data\\User-PC.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'latin1_swedish_ci'),
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.20\\data\\User-PC.log'),
('FLUSH_TIME', '1800'),
...
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.20\\data\\User-PC-slow.log'),
('CHARACTER_SET_SYSTEM', 'utf8'),
('SYSTEM_TIME_ZONE', 'Azores Standard Time'),
...
('def', 'db_ecommerce_batch09', 'PRIMARY', 'def', 'db_ecommerce_batch09', 'tbl_admin', 'admin_id', 1, NULL, NULL, NULL, NULL),
('def', 'db_ecommerce_batch09', 'PRIMARY', 'def', 'db_ecommerce_batch09', 'tbl_category', 'category_id', 1, NULL, NULL, NULL, NULL),
('def', 'db_ecommerce_batch09', 'PRIMARY', 'def', 'db_ecommerce_batch09', 'tbl_client', 'client_id', 1, NULL, NULL, NULL, NULL),
('def', 'db_ecommerce_batch09', 'PRIMARY', 'def', 'db_ecommerce_batch09', 'tbl_customer', 'customer_id', 1, NULL, NULL, NULL, NULL),
('def', 'db_ecommerce_batch09', 'PRIMARY', 'def', 'db_ecommerce_batch09', 'tbl_product', 'product_id', 1, NULL, NULL, NULL, NULL),
('def', 'dbebusiness', 'PRIMARY', 'def', 'dbebusiness', 'tbl_admin', 'admin_id', 1, NULL, NULL, NULL, NULL),
('def', 'dbebusiness', 'PRIMARY', 'def', 'dbebusiness', 'tbl_category', 'category_id', 1, NULL, NULL, NULL, NULL),
('def', 'dbebusiness', 'PRIMARY', 'def', 'dbebusiness', 'tbl_client', 'client_id', 1, NULL, NULL, NULL, NULL),
('def', 'dbebusiness', 'PRIMARY', 'def', 'dbebusiness', 'tbl_customer', 'customer_id', 1, NULL, NULL, NULL, NULL),
('def', 'dbebusiness', 'PRIMARY', 'def', 'dbebusiness', 'tbl_product', 'product_id', 1, NULL, NULL, NULL, NULL),
('def', 'dbecommerce', 'PRIMARY', 'def', 'dbecommerce', 'tbadmin', 'admin_id', 1, NULL, NULL, NULL, NULL),
('def', 'dbecommerce', 'PRIMARY', 'def', 'dbecommerce', 'tbcategory', 'category_id', 1, NULL, NULL, NULL, NULL),
('def', 'dbecommerce', 'PRIMARY', 'def', 'dbecommerce', 'tblclient', 'client_id', 1, NULL, NULL, NULL, NULL),
('def', 'dbecommerce', 'PRIMARY', 'def', 'dbecommerce', 'tblcustomer', 'customer_id', 1, NULL, NULL, NULL, NULL),
('def', 'dbecommerce', 'PRIMARY', 'def', 'dbecommerce', 'tbproduct', 'product_id', 1, NULL, NULL, NULL, NULL),
...
('def', 'shop_apps', 'PRIMARY', 'def', 'shop_apps', 'tbl_category', 'category_id', 1, NULL, NULL, NULL, NULL),
('def', 'shop_apps', 'PRIMARY', 'def', 'shop_apps', 'tbl_product', 'product_id', 1, NULL, NULL, NULL, NULL),
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2017-01-01 08:32:48', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2017-01-01 08:32:48', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2017-01-01 08:32:48', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-01-01 08:32:48', '2017-01-01 08:32:48', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2017-01-01 08:32:48', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2017-01-01 08:32:48', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-01-01 08:32:48', '2017-01-01 08:32:48', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2017-01-01 08:32:48', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-01-01 08:32:49', '2017-01-01 08:32:49', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-01-01 08:32:49', '2017-01-01 08:32:49', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-01-01 08:32:49', '2017-01-01 08:32:49', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-01-01 08:32:49', '2017-01-01 08:32:49', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-01-01 08:32:49', '2017-01-01 08:32:49', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-01-01 08:32:49', '2017-01-01 08:32:49', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-01-01 08:32:49', '2017-01-01 08:32:49', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2017-01-01 08:32:49', NULL, NULL, NULL, '', '', NULL),
('def', 'db_ecommerce_batch09', 'tbl_admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2016-08-25 03:49:57', NULL, NULL, NULL, '', '', NULL),
('def', 'db_ecommerce_batch09', 'tbl_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2016-08-25 03:49:57', NULL, NULL, NULL, '', '', NULL),
('def', 'db_ecommerce_batch09', 'tbl_client', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 0, '2016-08-25 03:49:57', NULL, NULL, NULL, '', '', NULL),
('def', 'db_ecommerce_batch09', 'tbl_customer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 96, 96, 281474976710655, 2048, 0, '2016-08-25 03:49:57', '2016-08-25 04:05:55', NULL, NULL, '', '', NULL),
('def', 'db_ecommerce_batch09', 'tbl_product', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 2730, 16384, NULL, 0, 0, '2016-08-25 03:49:57', NULL, NULL, NULL, '', '', NULL),
('def', 'dbebusiness', 'tbl_admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2016-08-25 03:51:22', NULL, NULL, NULL, '', '', NULL),
('def', 'dbebusiness', 'tbl_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2016-08-25 03:51:23', NULL, NULL, NULL, '', '', NULL),
('def', 'dbebusiness', 'tbl_client', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 0, '2016-08-25 03:51:23', NULL, NULL, NULL, '', '', NULL),
('def', 'dbebusiness', 'tbl_customer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 96, 96, 281474976710655, 2048, 0, '2016-08-25 03:51:23', '2016-08-25 03:51:23', NULL, NULL, '', '', NULL),
('def', 'dbebusiness', 'tbl_product', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2016-08-25 03:51:23', NULL, NULL, NULL, '', '', NULL),
('def', 'dbecommerce', 'tbadmin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2016-08-25 03:51:01', NULL, NULL, NULL, '', '', NULL),
('def', 'dbecommerce', 'tbcategory', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2016-08-25 03:51:01', NULL, NULL, NULL, '', '', NULL),
('def', 'dbecommerce', 'tblclient', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 0, '2016-08-25 03:51:01', NULL, NULL, NULL, '', '', NULL),
('def', 'dbecommerce', 'tblcustomer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 96, 96, 281474976710655, 2048, 0, '2016-08-25 03:51:01', '2016-08-25 03:51:01', NULL, NULL, '', '', NULL),
('def', 'dbecommerce', 'tbproduct', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2016-08-25 03:51:01', NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', '2011-12-16 21:27:59', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 465, 197, 91605, 55450570411999231, 16384, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1028, 9, 9252, 2533274790395903, 19456, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 508, 867, 440716, 281474976710655, 20480, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 693, 693, 195062158860484607, 5120, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', '2011-12-16 21:27:59', NULL, '', '', NULL),
('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 53, 212, 281474976710655, 2048, 0, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, NULL, '', '', NULL),
...
('def', 'shop_apps', 'tbl_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2016-12-30 16:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'shop_apps', 'tbl_product', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, 1820, 16384, NULL, 0, 0, '2016-12-30 16:10:31', NULL, NULL, NULL, '', '', NULL),
('def', 'wordpress', 'wp_commentmeta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2016-08-25 03:38:32', NULL, NULL, NULL, '', '', NULL),
('def', 'wordpress', 'wp_comments', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 81920, 0, '2016-08-25 03:38:32', NULL, NULL, NULL, '', '', NULL),
('def', 'wordpress', 'wp_links', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2016-08-25 03:38:32', NULL, NULL, NULL, '', '', NULL),
('def', 'wordpress', 'wp_options', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 35, 1872, 65536, NULL, 16384, 0, '2016-08-25 03:38:32', NULL, NULL, NULL, '', '', NULL),
('def', 'wordpress', 'wp_postmeta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 32768, 0, '2016-08-25 03:38:32', NULL, NULL, NULL, '', '', NULL),
('def', 'wordpress', 'wp_posts', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 65536, 0, '2016-08-25 03:38:32', NULL, NULL, NULL, '', '', NULL),
('def', 'wordpress', 'wp_term_relationships', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 16384, 0, '2016-08-25 03:38:32', NULL, NULL, NULL, '', '', NULL),
('def', 'wordpress', 'wp_term_taxonomy', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 32768, 0, '2016-08-25 03:38:31', NULL, NULL, NULL, '', '', NULL),
('def', 'wordpress', 'wp_terms', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 32768, 0, '2016-08-25 03:38:31', NULL, NULL, NULL, '', '', NULL),
('def', 'wordpress', 'wp_usermeta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15, 1092, 16384, NULL, 32768, 0, '2016-08-25 03:38:31', NULL, NULL, NULL, '', '', NULL),
('def', 'wordpress', 'wp_users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 32768, 0, '2016-08-25 03:38:31', NULL, NULL, NULL, '', '', NULL);
...
(14, 'root', 'localhost:1330', 'dbecommerce', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(9, 'root', 'localhost:1250', 'shop_apps', 'Sleep', 44, '', NULL),
(8, 'root', 'localhost:1211', 'shop_apps', 'Sleep', 75, '', NULL),
(1, 'root', 'localhost:1038', 'shop_apps', 'Sleep', 1044, '', NULL);
...
('def', 'db_ecommerce_batch09', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'dbebusiness', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'dbecommerce', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'performance_schema', 'utf8', 'utf8_general_ci', NULL),
('def', 'shop_apps', 'latin1', 'latin1_swedish_ci', NULL),
...
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '2612'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '2580'),
('INNODB_BUFFER_POOL_PAGES_DATA', '413'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '38'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7778'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '4941'),
('INNODB_BUFFER_POOL_READS', '414'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '37'),
('INNODB_DATA_FSYNCS', '38'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '8966144'),
('INNODB_DATA_READS', '424'),
('INNODB_DATA_WRITES', '49'),
('INNODB_DATA_WRITTEN', '636928'),
('INNODB_DBLWR_PAGES_WRITTEN', '19'),
('INNODB_DBLWR_WRITES', '7'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '1141'),
('UPTIME_SINCE_FLUSH_STATUS', '1141');
...
('def', 'db_ecommerce_batch09', 'tbl_admin', 0, 'db_ecommerce_batch09', 'PRIMARY', 1, 'admin_id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'db_ecommerce_batch09', 'tbl_category', 0, 'db_ecommerce_batch09', 'PRIMARY', 1, 'category_id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'db_ecommerce_batch09', 'tbl_client', 0, 'db_ecommerce_batch09', 'PRIMARY', 1, 'client_id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'db_ecommerce_batch09', 'tbl_customer', 0, 'db_ecommerce_batch09', 'PRIMARY', 1, 'customer_id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'db_ecommerce_batch09', 'tbl_product', 0, 'db_ecommerce_batch09', 'PRIMARY', 1, 'product_id', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dbebusiness', 'tbl_admin', 0, 'dbebusiness', 'PRIMARY', 1, 'admin_id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dbebusiness', 'tbl_category', 0, 'dbebusiness', 'PRIMARY', 1, 'category_id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dbebusiness', 'tbl_client', 0, 'dbebusiness', 'PRIMARY', 1, 'client_id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dbebusiness', 'tbl_customer', 0, 'dbebusiness', 'PRIMARY', 1, 'customer_id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dbebusiness', 'tbl_product', 0, 'dbebusiness', 'PRIMARY', 1, 'product_id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dbecommerce', 'tbadmin', 0, 'dbecommerce', 'PRIMARY', 1, 'admin_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dbecommerce', 'tbcategory', 0, 'dbecommerce', 'PRIMARY', 1, 'category_id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dbecommerce', 'tblclient', 0, 'dbecommerce', 'PRIMARY', 1, 'client_id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dbecommerce', 'tblcustomer', 0, 'dbecommerce', 'PRIMARY', 1, 'customer_id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dbecommerce', 'tbproduct', 0, 'dbecommerce', 'PRIMARY', 1, 'product_id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'shop_apps', 'tbl_category', 0, 'shop_apps', 'PRIMARY', 1, 'category_id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop_apps', 'tbl_product', 0, 'shop_apps', 'PRIMARY', 1, 'product_id', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'wordpress', 'wp_comments', 0, 'wordpress', 'PRIMARY', 1, 'comment_ID', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_comments', 1, 'wordpress', 'comment_post_ID', 1, 'comment_post_ID', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_comments', 1, 'wordpress', 'comment_approved_date_gmt', 1, 'comment_approved', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_comments', 1, 'wordpress', 'comment_approved_date_gmt', 2, 'comment_date_gmt', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_comments', 1, 'wordpress', 'comment_date_gmt', 1, 'comment_date_gmt', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_comments', 1, 'wordpress', 'comment_parent', 1, 'comment_parent', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_comments', 1, 'wordpress', 'comment_author_email', 1, 'comment_author_email', 'A', 1, 10, NULL, '', 'BTREE', '', ''),
...
('def', 'wordpress', 'wp_options', 0, 'wordpress', 'PRIMARY', 1, 'option_id', 'A', 97, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_options', 0, 'wordpress', 'option_name', 1, 'option_name', 'A', 97, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_postmeta', 0, 'wordpress', 'PRIMARY', 1, 'meta_id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_postmeta', 1, 'wordpress', 'post_id', 1, 'post_id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_postmeta', 1, 'wordpress', 'meta_key', 1, 'meta_key', 'A', 1, 191, NULL, 'YES', 'BTREE', '', ''),
('def', 'wordpress', 'wp_posts', 0, 'wordpress', 'PRIMARY', 1, 'ID', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_posts', 1, 'wordpress', 'post_name', 1, 'post_name', 'A', 3, 191, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_posts', 1, 'wordpress', 'type_status_date', 1, 'post_type', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_posts', 1, 'wordpress', 'type_status_date', 2, 'post_status', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_posts', 1, 'wordpress', 'type_status_date', 3, 'post_date', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_posts', 1, 'wordpress', 'type_status_date', 4, 'ID', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_posts', 1, 'wordpress', 'post_parent', 1, 'post_parent', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_posts', 1, 'wordpress', 'post_author', 1, 'post_author', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_term_relationships', 0, 'wordpress', 'PRIMARY', 1, 'object_id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_term_relationships', 0, 'wordpress', 'PRIMARY', 2, 'term_taxonomy_id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_term_relationships', 1, 'wordpress', 'term_taxonomy_id', 1, 'term_taxonomy_id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_term_taxonomy', 0, 'wordpress', 'PRIMARY', 1, 'term_taxonomy_id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_term_taxonomy', 0, 'wordpress', 'term_id_taxonomy', 1, 'term_id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_term_taxonomy', 0, 'wordpress', 'term_id_taxonomy', 2, 'taxonomy', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_term_taxonomy', 1, 'wordpress', 'taxonomy', 1, 'taxonomy', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_terms', 0, 'wordpress', 'PRIMARY', 1, 'term_id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_terms', 1, 'wordpress', 'slug', 1, 'slug', 'A', 1, 191, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_terms', 1, 'wordpress', 'name', 1, 'name', 'A', 1, 191, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_usermeta', 0, 'wordpress', 'PRIMARY', 1, 'umeta_id', 'A', 15, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_usermeta', 1, 'wordpress', 'user_id', 1, 'user_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'wordpress', 'wp_usermeta', 1, 'wordpress', 'meta_key', 1, 'meta_key', 'A', 15, 191, NULL, 'YES', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-01-01 08:32:49', '2017-01-01 08:32:49', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-01-01 08:32:49', '2017-01-01 08:32:49', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-01-01 08:32:49', '2017-01-01 08:32:49', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-01-01 08:32:49', '2017-01-01 08:32:49', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-01-01 08:32:49', '2017-01-01 08:32:49', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-01-01 08:32:49', '2017-01-01 08:32:49', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-01-01 08:32:49', '2017-01-01 08:32:49', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-01-01 08:32:49', '2017-01-01 08:32:49', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-01-01 08:32:49', '2017-01-01 08:32:49', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2017-01-01 08:32:49', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'db_ecommerce_batch09', 'tbl_admin', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 6291456, 2, '2016-08-25 03:49:57', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'db_ecommerce_batch09', 'tbl_category', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 6291456, 8, '2016-08-25 03:49:57', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'db_ecommerce_batch09', 'tbl_client', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 6291456, 12, '2016-08-25 03:49:57', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'db_ecommerce_batch09', 'tbl_customer', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 96, 96, 281474976710655, 2048, 0, 2, '2016-08-25 03:49:57', '2016-08-25 04:05:55', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'db_ecommerce_batch09', 'tbl_product', 'BASE TABLE', 'InnoDB', 10, 'Compact', 6, 2730, 16384, 0, 0, 6291456, 12, '2016-08-25 03:49:57', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'dbebusiness', 'tbl_admin', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 6291456, 2, '2016-08-25 03:51:22', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'dbebusiness', 'tbl_category', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 6291456, 8, '2016-08-25 03:51:23', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'dbebusiness', 'tbl_client', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 6291456, 12, '2016-08-25 03:51:23', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'dbebusiness', 'tbl_customer', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 96, 96, 281474976710655, 2048, 0, 2, '2016-08-25 03:51:23', '2016-08-25 03:51:23', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'dbebusiness', 'tbl_product', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 6291456, 9, '2016-08-25 03:51:23', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'dbecommerce', 'tbadmin', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 6291456, 3, '2016-08-25 03:51:01', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'dbecommerce', 'tbcategory', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 6291456, 8, '2016-08-25 03:51:01', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'dbecommerce', 'tblclient', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 6291456, 12, '2016-08-25 03:51:01', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'dbecommerce', 'tblcustomer', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 96, 96, 281474976710655, 2048, 0, 2, '2016-08-25 03:51:01', '2016-08-25 03:51:01', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'dbecommerce', 'tbproduct', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 6291456, 9, '2016-08-25 03:51:01', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', '2011-12-16 21:27:59', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_general_ci', NULL, '', 'Events'),
('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 465, 197, 91605, 55450570411999231, 16384, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1028, 9, 9252, 2533274790395903, 19456, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 508, 867, 440716, 281474976710655, 20480, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 693, 693, 195062158860484607, 5120, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', '2011-12-16 21:27:59', 'utf8_bin', NULL, '', 'User proxy privileges'),
('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 53, 212, 281474976710655, 2048, 0, NULL, '2011-12-16 21:27:59', '2012-01-25 03:56:42', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'shop_apps', 'tbl_category', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 6291456, 8, '2016-12-30 16:10:30', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'shop_apps', 'tbl_product', 'BASE TABLE', 'InnoDB', 10, 'Compact', 9, 1820, 16384, 0, 0, 6291456, 32, '2016-12-30 16:10:31', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'wordpress', 'wp_commentmeta', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 6291456, 1, '2016-08-25 03:38:32', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'wordpress', 'wp_comments', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 81920, 6291456, 2, '2016-08-25 03:38:32', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'wordpress', 'wp_links', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 6291456, 1, '2016-08-25 03:38:32', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'wordpress', 'wp_options', 'BASE TABLE', 'InnoDB', 10, 'Compact', 99, 661, 65536, 0, 16384, 6291456, 128, '2016-08-25 03:38:32', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'wordpress', 'wp_postmeta', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 32768, 6291456, 2, '2016-08-25 03:38:32', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'wordpress', 'wp_posts', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 65536, 6291456, 4, '2016-08-25 03:38:32', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'wordpress', 'wp_term_relationships', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 16384, 6291456, NULL, '2016-08-25 03:38:32', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'wordpress', 'wp_term_taxonomy', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 32768, 6291456, 2, '2016-08-25 03:38:31', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'wordpress', 'wp_terms', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 32768, 6291456, 2, '2016-08-25 03:38:31', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'wordpress', 'wp_usermeta', 'BASE TABLE', 'InnoDB', 10, 'Compact', 15, 1092, 16384, 0, 32768, 6291456, 16, '2016-08-25 03:38:31', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
('def', 'wordpress', 'wp_users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 32768, 6291456, 2, '2016-08-25 03:38:31', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', '');
...
('def', 'db_ecommerce_batch09', 'PRIMARY', 'db_ecommerce_batch09', 'tbl_admin', 'PRIMARY KEY'),
('def', 'db_ecommerce_batch09', 'PRIMARY', 'db_ecommerce_batch09', 'tbl_category', 'PRIMARY KEY'),
('def', 'db_ecommerce_batch09', 'PRIMARY', 'db_ecommerce_batch09', 'tbl_client', 'PRIMARY KEY'),
('def', 'db_ecommerce_batch09', 'PRIMARY', 'db_ecommerce_batch09', 'tbl_customer', 'PRIMARY KEY'),
('def', 'db_ecommerce_batch09', 'PRIMARY', 'db_ecommerce_batch09', 'tbl_product', 'PRIMARY KEY'),
('def', 'dbebusiness', 'PRIMARY', 'dbebusiness', 'tbl_admin', 'PRIMARY KEY'),
('def', 'dbebusiness', 'PRIMARY', 'dbebusiness', 'tbl_category', 'PRIMARY KEY'),
('def', 'dbebusiness', 'PRIMARY', 'dbebusiness', 'tbl_client', 'PRIMARY KEY'),
('def', 'dbebusiness', 'PRIMARY', 'dbebusiness', 'tbl_customer', 'PRIMARY KEY'),
('def', 'dbebusiness', 'PRIMARY', 'dbebusiness', 'tbl_product', 'PRIMARY KEY'),
('def', 'dbecommerce', 'PRIMARY', 'dbecommerce', 'tbadmin', 'PRIMARY KEY'),
('def', 'dbecommerce', 'PRIMARY', 'dbecommerce', 'tbcategory', 'PRIMARY KEY'),
('def', 'dbecommerce', 'PRIMARY', 'dbecommerce', 'tblclient', 'PRIMARY KEY'),
('def', 'dbecommerce', 'PRIMARY', 'dbecommerce', 'tblcustomer', 'PRIMARY KEY'),
('def', 'dbecommerce', 'PRIMARY', 'dbecommerce', 'tbproduct', 'PRIMARY KEY'),
...
('def', 'shop_apps', 'PRIMARY', 'shop_apps', 'tbl_category', 'PRIMARY KEY'),
('def', 'shop_apps', 'PRIMARY', 'shop_apps', 'tbl_product', 'PRIMARY KEY'),
...
('localhost', 'root', '', '', 1, '', '2011-12-16 21:27:59');
...
-- Database: `shop_apps`
--
CREATE DATABASE `shop_apps` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `shop_apps`;
...
INSERT INTO `tbl_category` (`category_id`, `category_name`, `category_description`, `publication_status`) VALUES
(1, 'Men''s Clothing', 'First Category description', 1),
(6, 'Women''s Clothing', 'This is Second Category.', 1),
(7, 'Electronics', 'This is Third category', 1);
...
INSERT INTO `tbl_product` (`product_id`, `product_name`, `product_description`, `product_price`, `product_quantity`, `product_image`, `category_id`, `publication_status`) VALUES
(20, 'Accer Laptop', '\r\nAccer Laptop performs well', 10, 0, 'http://localhost/shop/images/product_images/big_pic1.jpg', 6, 1),
(21, 'Jacket', 'Men''s comfortable winter jacket', 10, 1, 'http://localhost/shop/images/product_images/bann2.jpg', 1, 1),
(25, 'HP Compact', 'Peroform well for all ages ', 0, 5, 'http://localhost/shop/images/product_images/Jellyfish.jpg', 7, 1),
(26, 'HP Compact 44400', 'HP Compact with High Speed', 0, 5, 'http://localhost/shop/images/product_images/indexffff.jpg', 7, 1),
(27, 'IPhone 7S', 'Iphone 7s with extended IOS features', 0, 10, 'http://localhost/shop/images/product_images/o.jpg', 7, 1),
(28, 'Men''s Sleeve Shirt', 'Men''s sleeve shirt with different colors', 0, 10, 'http://localhost/shop/images/product_images/indexb.jpg', 1, 1),
(29, 'Men''s Sweater', 'Men''s winter sweater', 0, 5, 'http://localhost/shop/images/product_images/index.jpg', 1, 1),
(30, 'Women''s Tops', 'Women''s stylish tops', 0, 10, 'http://localhost/shop/images/product_images/a.jpg', 6, 1),
(31, 'Winter Jacket', 'Women''s stylish winter jacket', 0, 5, 'http://localhost/shop/images/product_images/indexf.jpg', 6, 1);
--
-- Database: `test`
--
...
(1, 1, 'Mr WordPress', '', 'https://wordpress.org/', '', '2016-08-25 03:38:45', '2016-08-25 03:38:45', 'Hi, this is a comment.\nTo delete a comment, just log in and view the post&#039;s comments. There you will have the option to edit or delete them.', 0, '1', '', '', 0, 0);
...
(3, 'blogname', 'LearningThroughPractice', 'yes'),
...
(42, 'stylesheet', 'twentyfourteen-child', 'yes'),
...
(95, 'sidebars_widgets', 'a:6:{s:19:"wp_inactive_widgets";a:0:{}s:15:"new_widget_name";a:6:{i:0;s:8:"search-2";i:1;s:14:"recent-posts-2";i:2;s:17:"recent-comments-2";i:3;s:10:"archives-2";i:4;s:12:"categories-2";i:5;s:6:"meta-2";}s:9:"sidebar-1";N;s:9:"sidebar-2";N;s:9:"sidebar-3";N;s:13:"array_version";i:3;}', 'yes'),
(98, 'cron', 'a:3:{i:1472139528;a:3:{s:16:"wp_version_check";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}s:17:"wp_update_plugins";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}s:16:"wp_update_themes";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}}i:1472182744;a:1:{s:19:"wp_scheduled_delete";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:5:"daily";s:4:"args";a:0:{}s:8:"interval";i:86400;}}}s:7:"version";i:2;}', 'yes'),
...
(102, '_site_transient_update_core', 'O:8:"stdClass":4:{s:7:"updates";a:1:{i:0;O:8:"stdClass":10:{s:8:"response";s:7:"upgrade";s:8:"download";s:56:"http://downloads.wordpress.org/release/wordpress-4.6.zip";s:6:"locale";s:5:"en_US";s:8:"packages";O:8:"stdClass":5:{s:4:"full";s:56:"http://downloads.wordpress.org/release/wordpress-4.6.zip";s:10:"no_content";s:67:"http://downloads.wordpress.org/release/wordpress-4.6-no-content.zip";s:11:"new_bundled";s:68:"http://downloads.wordpress.org/release/wordpress-4.6-new-bundled.zip";s:7:"partial";b:0;s:8:"rollback";b:0;}s:7:"current";s:3:"4.6";s:7:"version";s:3:"4.6";s:11:"php_version";s:5:"5.2.4";s:13:"mysql_version";s:3:"5.0";s:11:"new_bundled";s:3:"4.4";s:15:"partial_version";s:0:"";}}s:12:"last_checked";i:1472096335;s:15:"version_checked";s:5:"4.2.9";s:12:"translations";a:0:{}}', 'yes'),
(105, '_site_transient_timeout_theme_roots', '1472098138', 'yes'),
(106, '_site_transient_theme_roots', 'a:18:{s:17:"BP-Default-master";s:7:"/themes";s:6:"Endolf";s:7:"/themes";s:8:"LifeBlog";s:7:"/themes";s:9:"MusicStar";s:7:"/themes";s:4:"Plex";s:7:"/themes";s:13:"best-magazine";s:7:"/themes";s:8:"colormag";s:7:"/themes";s:5:"flexy";s:7:"/themes";s:16:"mh-magazine-lite";s:7:"/themes";s:7:"moderna";s:7:"/themes";s:13:"precious-lite";s:7:"/themes";s:14:"smart-magazine";s:7:"/themes";s:6:"sporty";s:7:"/themes";s:13:"twentyfifteen";s:7:"/themes";s:20:"twentyfourteen-child";s:7:"/themes";s:14:"twentyfourteen";s:7:"/themes";s:13:"twentysixteen";s:7:"/themes";s:14:"twentythirteen";s:7:"/themes";}', 'yes'),
(108, '_site_transient_update_themes', 'O:8:"stdClass":4:{s:12:"last_checked";i:1472096348;s:7:"checked";a:18:{s:17:"BP-Default-master";s:3:"2.1";s:6:"Endolf";s:3:"1.1";s:8:"LifeBlog";s:3:"1.1";s:9:"MusicStar";s:3:"3.5";s:4:"Plex";s:3:"1.1";s:13:"best-magazine";s:6:"1.1.18";s:8:"colormag";s:5:"1.1.2";s:5:"flexy";s:6:"1.0.11";s:16:"mh-magazine-lite";s:5:"2.1.3";s:7:"moderna";s:0:"";s:13:"precious-lite";s:5:"1.2.5";s:14:"smart-magazine";s:5:"1.0.6";s:6:"sporty";s:5:"1.7.1";s:13:"twentyfifteen";s:3:"1.2";s:20:"twentyfourteen-child";s:5:"1.0.0";s:14:"twentyfourteen";s:3:"1.4";s:13:"twentysixteen";s:3:"1.3";s:14:"twentythirteen";s:3:"1.5";}s:8:"response";a:7:{s:13:"best-magazine";a:4:{s:5:"theme";s:13:"best-magazine";s:11:"new_version";s:6:"1.1.20";s:3:"url";s:43:"https://wordpress.org/themes/best-magazine/";s:7:"package";s:61:"http://downloads.wordpress.org/theme/best-magazine.1.1.20.zip";}s:8:"colormag";a:4:{s:5:"theme";s:8:"colormag";s:11:"new_version";s:5:"1.1.4";s:3:"url";s:38:"https://wordpress.org/themes/colormag/";s:7:"package";s:55:"http://downloads.wordpress.org/theme/colormag.1.1.4.zip";}s:16:"mh-magazine-lite";a:4:{s:5:"theme";s:16:"mh-magazine-lite";s:11:"new_version";s:5:"2.4.1";s:3:"url";s:46:"https://wordpress.org/themes/mh-magazine-lite/";s:7:"package";s:63:"http://downloads.wordpress.org/theme/mh-magazine-lite.2.4.1.zip";}s:6:"sporty";a:4:{s:5:"theme";s:6:"sporty";s:11:"new_version";s:5:"1.7.2";s:3:"url";s:36:"https://wordpress.org/themes/sporty/";s:7:"package";s:53:"http://downloads.wordpress.org/theme/sporty.1.7.2.zip";}s:13:"twentyfifteen";a:4:{s:5:"theme";s:13:"twentyfifteen";s:11:"new_version";s:3:"1.6";s:3:"url";s:43:"https://wordpress.org/themes/twentyfifteen/";s:7:"package";s:58:"http://downloads.wordpress.org/theme/twentyfifteen.1.6.zip";}s:14:"twentyfourteen";a:4:{s:5:"theme";s:14:"twentyfourteen";s:11:"new_version";s:3:"1.8";s:3:"url";s:44:"https://wordpress.org/themes/twentyfourteen/";s:7:"package";s:59:"http://downloads.wordpress.org/theme/twentyfourteen.1.8.zip";}s:14:"twentythirteen";a:4:{s:5:"theme";s:14:"twentythirteen";s:11:"new_version";s:3:"2.0";s:3:"url";s:44:"https://wordpress.org/themes/twentythirteen/";s:7:"package";s:59:"http://downloads.wordpress.org/theme/twentythirteen.2.0.zip";}}s:12:"translations";a:0:{}}', 'yes'),
(109, '_site_transient_update_plugins', 'O:8:"stdClass":4:{s:12:"last_checked";i:1472096342;s:8:"response";a:6:{s:19:"akismet/akismet.php";O:8:"stdClass":6:{s:2:"id";s:2:"15";s:4:"slug";s:7:"akismet";s:6:"plugin";s:19:"akismet/akismet.php";s:11:"new_version";s:6:"3.1.11";s:3:"url";s:38:"https://wordpress.org/plugins/akismet/";s:7:"package";s:56:"http://downloads.wordpress.org/plugin/akismet.3.1.11.zip";}s:24:"buddypress/bp-loader.php";O:8:"stdClass":7:{s:2:"id";s:4:"7756";s:4:"slug";s:10:"buddypress";s:6:"plugin";s:24:"buddypress/bp-loader.php";s:11:"new_version";s:5:"2.6.2";s:3:"url";s:41:"https://wordpress.org/plugins/buddypress/";s:7:"package";s:58:"http://downloads.wordpress.org/plugin/buddypress.2.6.2.zip";s:14:"upgrade_notice";s:57:"See: https://codex.buddypress.org/releases/version-2-6-2/";}s:26:"event-calendar-wd/ecwd.php";O:8:"stdClass":6:{s:2:"id";s:5:"61022";s:4:"slug";s:17:"event-calendar-wd";s:6:"plugin";s:26:"event-calendar-wd/ecwd.php";s:11:"new_version";s:6:"1.0.68";s:3:"url";s:48:"https://wordpress.org/plugins/event-calendar-wd/";s:7:"package";s:66:"http://downloads.wordpress.org/plugin/event-calendar-wd.1.0.68.zip";}s:39:"wd-instagram-feed/wd-instagram-feed.php";O:8:"stdClass":6:{s:2:"id";s:5:"66604";s:4:"slug";s:17:"wd-instagram-feed";s:6:"plugin";s:39:"wd-instagram-feed/wd-instagram-feed.php";s:11:"new_version";s:5:"1.1.8";s:3:"url";s:48:"https://wordpress.org/plugins/wd-instagram-feed/";s:7:"package";s:65:"http://downloads.wordpress.org/plugin/wd-instagram-feed.1.1.8.zip";}s:28:"slider/rocketlayerslider.php";O:8:"stdClass":6:{s:2:"id";s:5:"26553";s:4:"slug";s:6:"slider";s:6:"plugin";s:28:"slider/rocketlayerslider.php";s:11:"new_version";s:5:"2.2.9";s:3:"url";s:37:"https://wordpress.org/plugins/slider/";s:7:"package";s:54:"http://downloads.wordpress.org/plugin/slider.2.2.9.zip";}s:23:"slider-wd/slider-wd.php";O:8:"stdClass":6:{s:2:"id";s:5:"54207";s:4:"slug";s:9:"slider-wd";s:6:"plugin";s:23:"slider-wd/slider-wd.php";s:11:"new_version";s:6:"1.1.47";s:3:"url";s:40:"https://wordpress.org/plugins/slider-wd/";s:7:"package";s:58:"http://downloads.wordpress.org/plugin/slider-wd.1.1.47.zip";}}s:12:"translations";a:0:{}s:9:"no_update";a:2:{s:9:"hello.php";O:8:"stdClass":6:{s:2:"id";s:4:"3564";s:4:"slug";s:11:"hello-dolly";s:6:"plugin";s:9:"hello.php";s:11:"new_version";s:3:"1.6";s:3:"url";s:42:"https://wordpress.org/plugins/hello-dolly/";s:7:"package";s:57:"http://downloads.wordpress.org/plugin/hello-dolly.1.6.zip";}s:64:"json-rest-api-wp-api-categories-and-tags/json-rest-api-patch.php";O:8:"stdClass":6:{s:2:"id";s:5:"53801";s:4:"slug";s:40:"json-rest-api-wp-api-categories-and-tags";s:6:"plugin";s:64:"json-rest-api-wp-api-categories-and-tags/json-rest-api-patch.php";s:11:"new_version";s:4:"1.01";s:3:"url";s:71:"https://wordpress.org/plugins/json-rest-api-wp-api-categories-and-tags/";s:7:"package";s:87:"http://downloads.wordpress.org/plugin/json-rest-api-wp-api-categories-and-tags.1.01.zip";}}}', 'yes'),
(110, '_transient_random_seed', '1535b9b42e4c98021701964e816032f4', 'yes'),
(111, '_site_transient_timeout_browser_0751bffcb3a745dddec00abd88833d00', '1472701144', 'yes'),
(112, '_site_transient_browser_0751bffcb3a745dddec00abd88833d00', 'a:9:{s:8:"platform";s:7:"Windows";s:4:"name";s:7:"Firefox";s:7:"version";s:4:"49.0";s:10:"update_url";s:23:"http://www.firefox.com/";s:7:"img_src";s:50:"http://s.wordpress.org/images/browsers/firefox.png";s:11:"img_src_ssl";s:49:"https://wordpress.org/images/browsers/firefox.png";s:15:"current_version";s:2:"16";s:7:"upgrade";b:0;s:8:"insecure";b:0;}', 'yes'),
(115, 'can_compress_scripts', '1', 'yes'),
(116, '_transient_timeout_plugin_slugs', '1472182749', 'no'),
(117, '_transient_plugin_slugs', 'a:8:{i:0;s:19:"akismet/akismet.php";i:1;s:24:"buddypress/bp-loader.php";i:2;s:26:"event-calendar-wd/ecwd.php";i:3;s:9:"hello.php";i:4;s:39:"wd-instagram-feed/wd-instagram-feed.php";i:5;s:64:"json-rest-api-wp-api-categories-and-tags/json-rest-api-patch.php";i:6;s:28:"slider/rocketlayerslider.php";i:7;s:23:"slider-wd/slider-wd.php";}', 'no'),
(118, '_transient_timeout_dash_4077549d03da2e451c8b5f002294ff51', '1472139549', 'no'),
(119, '_transient_dash_4077549d03da2e451c8b5f002294ff51', '<div class="rss-widget"><p><strong>RSS Error</strong>: WP HTTP Error: There are no HTTP transports available which can complete the requested request.</p></div><div class="rss-widget"><p><strong>RSS Error</strong>: WP HTTP Error: There are no HTTP transports available which can complete the requested request.</p></div><div class="rss-widget"><ul></ul></div>', 'no'),
(120, '_transient_is_multi_author', '0', 'yes'),
(121, '_transient_twentyfifteen_categories', '1', 'yes'),
(122, 'theme_mods_twentyfifteen', 'a:1:{s:16:"sidebars_widgets";a:2:{s:4:"time";i:1472096384;s:4:"data";a:2:{s:19:"wp_inactive_widgets";a:0:{}s:9:"sidebar-1";a:6:{i:0;s:8:"search-2";i:1;s:14:"recent-posts-2";i:2;s:17:"recent-comments-2";i:3;s:10:"archives-2";i:4;s:12:"categories-2";i:5;s:6:"meta-2";}}}}', 'yes'),
(123, 'current_theme', 'Twenty Fourteen Child', 'yes'),
(124, 'theme_mods_twentyfourteen-child', 'a:1:{i:0;b:0;}', 'yes'),
(125, 'theme_switched', '', 'yes'),
(126, '_transient_featured_content_ids', 'a:0:{}', 'yes'),
...
(1, 1, '2016-08-25 03:38:45', '2016-08-25 03:38:45', 'Welcome to WordPress. This is your first post. Edit or delete it, then start blogging!', 'Hello world!', '', 'publish', 'open', 'open', '', 'hello-world', '', '', '2016-08-25 03:38:45', '2016-08-25 03:38:45', '', 0, 'http://localhost/projects/wordpress/?p=1', 0, 'post', '', 1),
(2, 1, '2016-08-25 03:38:45', '2016-08-25 03:38:45', 'This is an example page. It''s different from a blog post because it will stay in one place and will show up in your site navigation (in most themes). Most people start with an About page that introduces them to potential site visitors. It might say something like this:\n\n<blockquote>Hi there! I''m a bike messenger by day, aspiring actor by night, and this is my blog. I live in Los Angeles, have a great dog named Jack, and I like pi&#241;a coladas. (And gettin'' caught in the rain.)</blockquote>\n\n...or something like this:\n\n<blockquote>The XYZ Doohickey Company was founded in 1971, and has been providing quality doohickeys to the public ever since. Located in Gotham City, XYZ employs over 2,000 people and does all kinds of awesome things for the Gotham community.</blockquote>\n\nAs a new WordPress user, you should go to <a href="http://localhost/projects/wordpress/wp-admin/">your dashboard</a> to delete this page and create new pages for your content. Have fun!', 'Sample Page', '', 'publish', 'open', 'open', '', 'sample-page', '', '', '2016-08-25 03:38:45', '2016-08-25 03:38:45', '', 0, 'http://localhost/projects/wordpress/?page_id=2', 0, 'page', '', 0),
(3, 1, '2016-08-25 03:39:05', '0000-00-00 00:00:00', '', 'Auto Draft', '', 'auto-draft', 'open', 'open', '', '', '', '', '2016-08-25 03:39:05', '0000-00-00 00:00:00', '', 0, 'http://localhost/projects/wordpress/?p=3', 0, 'post', '', 0);
...
(14, 1, 'session_tokens', 'a:1:{s:64:"ab2065716d71886440185c76904bc28f060f49d72192d5996de841d2acfca949";a:4:{s:10:"expiration";i:1472269142;s:2:"ip";s:9:"127.0.0.1";s:2:"ua";s:72:"Mozilla/5.0 (Windows NT 6.1; WOW64; rv:49.0) Gecko/20100101 Firefox/49.0";s:5:"login";i:1472096342;}}'),
...
(1, 'saon', '$P$BAtRyHyKauAbwcAhgrIm5ku1KZr3nD1', 'saon', 'swesaon@gmail.com', '', '2016-08-25 03:38:43', '', 0, 'saon');
